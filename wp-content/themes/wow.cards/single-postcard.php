...
# Добавить к JSON-свойствам открытки тексты из WP-записи
$meta_post = get_post_meta(get_the_id());
$card = Designs::get_postcard($meta_post['name_design'][0]);
if (isset($meta_post['text1'][0]))
	$card['txt']['default'] = $meta_post['text1'][0];
if (isset($card['txtTwo']) && isset($meta_post['text2'][0])) {
	$card['txtTwo']['default'] = $meta_post['text2'][0];
}
//var_dump($card);
//var_dump($meta_post);


# Определить, анимированна ли открытка
$is_gif = false;
if (substr($meta_post['name_design'][0], 0, 3) == 'gif')
	$is_gif = true;
define('IS_GIF', $is_gif);
$tag_postcard = 'canvas';
...
wp_enqueue_script('cards-js', get_stylesheet_directory_uri() . '/assets/js/' . $js_postcard,
    array('jquery'), filemtime( __DIR__ . '/assets/js/' . $js_postcard ), false);
...
<section id="stepCreatePostcard" class="step">
		...
		<div class="col-md-6 content">
			<div class="constructor-block">
				<div class="constructor"
					 ...
					 data-url-redirect="<?php echo home_url() ?>/suggest-formats-current-category/?type_design=postcard&id_category=<?php echo $id_category ?>">
					<div class="idle">
				...
				<div class="row">
					<div class="col-sm-6"><button class="download">Скачать открытку</button></div>
					<div class="col-sm-6">
	
						<a class="btn btn-primary shadow bubbly-button" style="margin-top: 25px;"
...
<?php
/*
<section id="stepSuggestFormatsCurrentCategory" class="step" style="display: none;">
	<?php
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="ya-share2" data-curtain data-size="l" data-url="https://<?php echo $_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] ?>"
...
<!-- Эффект зума текста вызывает баг(
<script>
