...
window.addEventListener('DOMContentLoaded', async function(){
	...
	style.innerHTML = (card.txt    != undefined ? '.constructor:hover .text-area{border-color:' + card.txt.color + ';} ' : '') +
					  ...
					  (card.txt    != undefined ? '@font-face{font-family:"' + card.txt.fontName + '"; src: url("' + urlLibCard + '/fonts/' + card.txt.fontFile + '");} ' : '') +
	...
	if (card.txt != undefined && card.txt.default != undefined) {
		defaultText = card.txt.default;
	}
